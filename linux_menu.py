...
def send_email():
    ...
    with smtplib.SMTP("smtp.gmail.com", 587) as smtp:
        smtp.starttls()
        smtp.login("enter you email", "enter your app password generated by gmail")  # Use your app password here
        smtp.sendmail(sender, receiver, message)

def send_sms():
    account_sid = 'enter your account_sid from Twilio'
    auth_token = 'enter your auth_token from Twilio'
    client = Client(account_sid, auth_token)
    to = input("Enter the recipient's number (with country code): ")
    from_ = 'enter the phone number given by twilio after creating account to it'
...
def post_to_social_media():
    ...
    if platform == 'telegram':
        token = input("Enter your Telegram bot token: ") #create your telegram bot first and then access token
